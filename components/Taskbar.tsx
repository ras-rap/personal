...
import { Folder, Info, Home, Search, FileText } from "lucide-react";

export default function Taskbar({ openApps, onOpenApp, appIcons }: { openApps: string[]; onOpenApp: (app: string) => void; appIcons: { [key: string]: JSX.Element } }) {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full h-12 bg-darkPurple flex items-center px-4 space-x-4">
      <button
